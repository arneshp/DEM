...
FixStyle(heat/gran/modified,FixHeatGran_modified)
FixStyle(heat/gran2,FixHeatGran_modified)

#else

#ifndef LMP_FIX_HEATGRAN_MODIFIED_H
#define LMP_FIX_HEATGRAN_MODIFIED_H
...
namespace LAMMPS_NS {
  ...
  class FixHeatGran_modified : public Fix {

    friend class FixMultisphere;
    friend class Multisphere;

  public:
    FixHeatGran_modified(class LAMMPS *, int, char **);
    ~FixHeatGran_modified(){};
