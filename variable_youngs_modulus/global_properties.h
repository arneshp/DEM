...
namespace MODEL_PARAMS
{
	...
	VectorProperty* createYoungsModuluslow(PropertyRegistry & registry, const char * caller, bool sanity_checks) ; // For Swelling model. 
	VectorProperty* createYoungsModulushigh(PropertyRegistry & registry, const char * caller, bool sanity_checks) ; // For swelling model.
