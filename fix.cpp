...
/* ----------------------------------------------------------------------
   ...
   This function is responsible for adding the virial components due to Fast lubrication forces.
------------------------------------------------------------------------- */

void Fix::v_tally_tensor(int i, int j, int nlocal, int newton_pair,
...
/* ----------------------------------------------------------------------
   ...
   Pairwise virial computation due to the Forces implemented via fix (say LubricationFLD) 
    
    Copied from Pair::ev_tally_xyz, (energy part is removed.)
------------------------------------------------------------------------- */

void Fix::v_tally_xyz(int i, int j, int nlocal, int newton_pair,
